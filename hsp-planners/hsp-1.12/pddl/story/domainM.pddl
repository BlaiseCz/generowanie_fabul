...
(infected ?character)
   ...
   (:action cure
	:parameters ( ?c1 ?c2 ?i ?l)
	:precondition (and (at ?c1  ?l ) (alive ?c1 ) (hero ?c1 ) (at ?c2  ?l ) (alive ?c2 ) (infected ?c2 ) (has ?c1  ?i ) (isantidote ?i ) (different ?c1  ?c2  ?c2  ?c2  ?c2  ?c1  ?i ))
	:effect (and (at ?c1  ?l ) (alive ?c1 ) (hero ?c1 ) (at ?c2  ?l ) (alive ?c2 ) (infected ?c2 ) (has ?c1  ?i ) (isantidote ?i ) (different ?c1  ?c2  ?c2  ?c2  ?c2  ?c1  ?i ))
   ...
   (:action feed
	:parameters ( ?c1 ?c2 ?i ?l)
	:precondition (and (at ?c1  ?l ) (alive ?c1 ) (hero ?c1 ) (at ?c2  ?l ) (alive ?c2 ) (starving ?c2 ) (has ?c1  ?i ) (isfood ?i ) (different ?c1  ?c2  ?c2  ?c2  ?c2  ?c1  ?i ))
	:effect (and (at ?c1  ?l ) (alive ?c1 ) (hero ?c1 ) (at ?c2  ?l ) (alive ?c2 ) (starving ?c2 ) (has ?c1  ?i ) (isfood ?i ) (different ?c1  ?c2  ?c2  ?c2  ?c2  ?c1  ?i ))
